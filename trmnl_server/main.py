...
from .routes import api_router, haushalt_router, image_router, page_router
from .services import plugins, state, calendar_watcher
...
app.include_router(haushalt_router)
